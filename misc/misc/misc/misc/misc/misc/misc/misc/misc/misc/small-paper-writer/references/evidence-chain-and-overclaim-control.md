...
- simple demo -> ?œsolves??a real-world problem
- one school / one class data -> conclusions about all students
- one model run -> claim that one method is ?œbest??in general
...
### B. Tool implementation + little testing + ?œproblem solved??language
Common topics:
- recognition systems
...
## 5. Demo-only overclaim: ?œwe built it??is not the same as ?œit works??
...
Do not confuse ?œruns successfully??with ?œvalidated thoroughly.??
...
Still avoid writing ?œbest method overall??unless your evaluation is much stronger than a normal student paper.
...
- says ?œimprove efficiency??without explaining where and how
- says ?œhigh accuracy??without giving numbers or comparison
- says ?œpractical value??without describing tested conditions
...
---
MERGED_FROM_BACKUP: C:\Users\wang\.openclaw\skills\misc\small-paper-writer\references\evidence-chain-and-overclaim-control.md
---
# Evidence Chain and Overclaim Control
